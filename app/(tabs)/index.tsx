      ...
      <SafeAreaView style={[styles.safe, { backgroundColor: theme.appBg }]}>
        <View style={[styles.container, { justifyContent: "center", alignItems: "center" }]}>
          <View
            style={[
              styles.card,
              { width: "100%", maxWidth: 420, backgroundColor: theme.cardBg, borderColor: theme.cardBorder },
            ]}
          >
            ...
            <View style={{ flexDirection: "row", justifyContent: "center", gap: 10, marginTop: 14 }}>
              <TouchableOpacity
                style={[styles.btn, { borderColor: theme.lightBorder, backgroundColor: theme.inputBg }]}
                onPress={() => {
              ...
              <TouchableOpacity
                style={[styles.btn, { borderColor: theme.lightBorder, backgroundColor: theme.highlightBg }]}
                onPress={() => {
...
if (adminPinReady) {
  ...
  function toggleSwipeCategory(k: SwipeCategoryKey) {
    const prev: SwipeCategories = config?.swipe?.categoriesEnabled ?? DEFAULT_SWIPE_CATEGORIES;
    ...
    setInConfig(["swipe", "categoriesEnabled"], next);
  }

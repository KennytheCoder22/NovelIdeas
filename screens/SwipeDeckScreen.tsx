...
function handleLeft() {
  ...
  async function performRecommendationRun(input: RecommenderInput) {
    ...
    try {
      ...
      setLastRecommendationSwipeSummary(`Right:${rightSwipes} • Left:${leftSwipes} • Skip:${downSwipes}`);
              ...
              <View style={styles.doneCard}>
                ...
                {!!recError && !recLoading ? (
                  <View style={{ marginTop: 12 }}>
                    ...
                    <TouchableOpacity style={[styles.btn, styles.btnGhost, { marginTop: 10, alignSelf: "center" }]} onPress={tryAgain}>
                ...
                {recItems.length > 0 && !recLoading && currentRec ? (
                  <View style={styles.recCard}>
                    ...
                    <View style={styles.recActions}>
                      ...
                      <TouchableOpacity style={[styles.btn, styles.btnGhost]} onPress={handleAlreadyRead}>
                ...
                <TouchableOpacity
                  style={[styles.btn, styles.btnGhost, { marginTop: 14, minWidth: 220, alignSelf: "center" }]}
              ...
              {isSmallScreen ? (
                <View style={styles.bottomPanel}>
                  <ScrollView style={{ width: "100%" }} contentContainerStyle={{ alignItems: "center", paddingBottom: 12 }} showsVerticalScrollIndicator={false}>
                    ...
                    <TouchableOpacity
                      style={[styles.btn, styles.btnGhost, { marginTop: 12, minWidth: 220 }]}
                      onPress={() => (props.onOpenSearch ? props.onOpenSearch() : router.push("/(tabs)/index"))}
                    >
                      <Text style={styles.btnText}>Search on my own</Text>
                    </TouchableOpacity>
                ...
                <>
                  <View style={styles.actionRow}>
                    <TouchableOpacity style={[styles.btn, styles.btnPrimary]} onPress={() => animateOffscreen("left", handleLeft)}>
                      <Text style={[styles.btnText, styles.btnTextOnPrimary]}>Dislike</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={[styles.btn, styles.btnPrimary]} onPress={() => animateOffscreen("down", handleDownNotSure)}>
                      <Text style={[styles.btnText, styles.btnTextOnPrimary]}>Skip</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                    ...
                    >
                      <Text style={[styles.btnText, styles.btnTextOnPrimary]}>Like</Text>
                    </TouchableOpacity>
                  </View>
                  <TouchableOpacity
                    style={[styles.btn, styles.btnGhost, { marginTop: 12, minWidth: 220 }]}
...
const styles = StyleSheet.create({
  ...
  deckChipSelected: { backgroundColor: "#2563eb", borderColor: "#1d4ed8" },

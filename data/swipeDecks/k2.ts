...
export const k2: SwipeDeck = {
  ...
  cards: [
    ...
    { isDefault: true, title: "Minecraft", author: "Mojang", genre: "Creative / Sandbox", wikiTitle: "Minecraft", tags: ["audience:children", "age:k2"] },
    { isDefault: true, title: "Animal Crossing: New Horizons", author: "Nintendo", genre: "Cozy / Life Sim", wikiTitle: "Animal Crossing: New Horizons", tags: ["audience:children", "age:k2", "vibe:cozy"] },
    { isDefault: true, title: "Mario Kart 8 Deluxe", author: "Nintendo", genre: "Racing / Party", wikiTitle: "Mario Kart 8 Deluxe", tags: ["audience:children", "age:k2"] },
    { isDefault: true, title: "Super Mario Odyssey", author: "Nintendo", genre: "Platformer / Adventure", wikiTitle: "Super Mario Odyssey", tags: ["audience:children", "age:k2", "genre:adventure"] },
    { isDefault: true, title: "Kirby and the Forgotten Land", author: "Nintendo", genre: "Platformer / Adventure", wikiTitle: "Kirby and the Forgotten Land", tags: ["audience:children", "age:k2", "genre:adventure"] },
    { isDefault: true, title: "Yoshi’s Crafted World", author: "Nintendo", genre: "Platformer / Cozy", wikiTitle: "Yoshi's Crafted World", tags: ["audience:children", "age:k2", "vibe:cozy"] },
    { isDefault: true, title: "LEGO City Undercover", author: "TT Games", genre: "Adventure / Comedy", wikiTitle: "Lego City Undercover", tags: ["audience:children", "age:k2", "genre:adventure", "genre:comedy"] },
    { isDefault: true, title: "LEGO Marvel Super Heroes", author: "TT Games", genre: "Action / Adventure", wikiTitle: "Lego Marvel Super Heroes", tags: ["audience:children", "age:k2", "genre:action", "genre:adventure"] },
    { isDefault: true, title: "Paw Patrol: On a Roll!", author: "Outright Games", genre: "Kids / Platformer", wikiTitle: "Paw Patrol: On a Roll!", tags: ["audience:children", "age:k2"] },
    { isDefault: true, title: "Pokémon: Let’s Go, Pikachu! / Eevee!", author: "Nintendo", genre: "Adventure / Creatures", wikiTitle: "Pokémon: Let's Go, Pikachu!", tags: ["audience:children", "age:k2", "genre:adventure", "genre:creatures"] },
    { isDefault: true, title: "New Pokémon Snap", author: "Nintendo", genre: "Photography / Adventure", wikiTitle: "New Pokémon Snap", tags: ["audience:children", "age:k2", "genre:adventure"] },
    { isDefault: true, title: "Scribblenauts Unlimited", author: "Warner Bros.", genre: "Puzzle / Creativity", wikiTitle: "Scribblenauts Unlimited", tags: ["audience:children", "age:k2"] },
    { isDefault: true, title: "Untitled Goose Game", author: "House House", genre: "Comedy / Puzzle", wikiTitle: "Untitled Goose Game", tags: ["audience:children", "age:k2", "genre:comedy"] },
    { isDefault: true, title: "Alba: A Wildlife Adventure", author: "ustwo", genre: "Adventure / Nature", wikiTitle: "Alba: A Wildlife Adventure", tags: ["audience:children", "age:k2", "genre:adventure", "genre:nature"] },
    { isDefault: true, title: "Disney Dreamlight Valley", author: "Gameloft", genre: "Cozy / Adventure", wikiTitle: "Disney Dreamlight Valley", tags: ["audience:children", "age:k2", "vibe:cozy", "genre:adventure"] },
